...
urlpatterns = [
    ...
    url(r'^.well-known/apple-app-site-association$', views.apple_site_association, name="well-known/apple-app-site-association"),
    url(r'^apple-app-site-association$', views.apple_site_association, name="apple-app-site-association"),
